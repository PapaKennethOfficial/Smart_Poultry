...
The seeded admin can sign in through the Manager/Admin area with `admin@smartpoultry.com` and the `ADMIN_PASSWORD` value from your backend `.env`. Public manager, customer, and delivery signup remains open.
